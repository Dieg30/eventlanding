...
export default function ComprarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fd.append('ticketPrice', String(unitPrice));
  ...
  return (
    <main className="bg-[#F8F8F6] text-[#0A0A0A] min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10 pt-28 pb-20">
        ...
        {/* Header */}
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="mb-8 lg:mb-10">
        ...
        <form onSubmit={handleSubmit} className="lg:grid lg:grid-cols-2 lg:gap-10 lg:items-start">
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.14 }}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {([
                { label: 'Nombre',   key: 'firstName', placeholder: 'Juan',       type: 'text' },
                { label: 'Apellido', key: 'lastName',  placeholder: 'Pérez',      type: 'text' },
                { label: 'Cédula',   key: 'document',  placeholder: '1712345678', type: 'text' },
                { label: 'Teléfono', key: 'phone',     placeholder: '0991234567', type: 'tel' },
              ...
              <div className="col-span-2">
                ...
                <input
                  type="email" placeholder="juan@correo.com" value={form.email}
                  onBlur={() => touch('email')}
          ...
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            ...
            <div className="border border-black/[0.09] bg-white rounded-2xl overflow-hidden mb-4">
              ...
              <div className="bg-[#00A44F] px-5 py-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-white/65 text-[11px]">Cuenta de Ahorros</p>
                </div>
              ...
              <div className="px-5 pt-4 pb-3 border-b border-black/[0.06]">
                ...
                <p className="text-[#0A0A0A] font-semibold text-sm">Diego Alexander Castro Benavides</p>
              </div>
